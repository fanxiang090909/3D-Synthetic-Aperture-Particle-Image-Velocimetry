    ...
    ui(new Ui::vector_result_widget)
{
    ...
    pivdata = new PivData(10, 10, 10);
    //pivdata->read(1,QString("D:\\SAPIV\\svn-piv\\v1.0\\hellogl-build-desktop\\B00001.dat"));
    pivdata->read(1,QString("D:\\velocity.txt"));
    //pivdata->read(1,QString("D:\\50x50x30velocity.txt"));
...
void vector_result_widget::setSettings(Settings* settingsPass)
{
    if (settingsPass != NULL)
        glWidget->setSettings(settingsPass);
}
