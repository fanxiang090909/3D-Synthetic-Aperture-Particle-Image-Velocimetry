...
struct PivPointData
{
    //! Horizontal dimension in vixels
    double x;
    //! Vertical dimension in vixels
    double y;
    //! z- dimension in vixels
    double z;

    //! Horizontal displacement in vixels
    double u;
    //! Vertical displacement in vixels
    double v;
    //! z displacement in vixels
    double w;
...
class PivData
{
    ...
    public:
        ...
        */
        PivData(int widthPass, int heightPass, int lengthPass);
        //! Destructor.
        virtual ~PivData();
        ...
        */
        ...
        /*!
          \sa setData();
        */
        PivPointData data(int i, int j, int k);
        //! Sets the data by passing PivPointData at (i,j) = (row, column) = (y, x)
        /*!
          \sa data();
        */
        void setData(int i, int j, int k, PivPointData dataPass);
        ...
        */
        ...
        bool filtered(int i, int j, int k);
        //! Set the value of the filter flag at point (i,j) = (y,x).
        void setFilter(int i, int j, int k, bool filterPass);
        ...
        void read(int indexPass, QString filename);
